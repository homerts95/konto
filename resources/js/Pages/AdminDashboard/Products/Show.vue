    ...
    <div class="pt-6">
      ...
      >
          ...
          <form class="mt-10">
            ...
            <div>
              ...
              <RadioGroup v-model="selectedColor" class="mt-4">
                <RadioGroupLabel class="sr-only"> {{useTrans('product.choose_color')}} </RadioGroupLabel>
            ...
            <div class="mt-10">
              ...
              <RadioGroup v-model="selectedSize" class="mt-4">
                <RadioGroupLabel class="sr-only"> {{useTrans('product.choose_size')}} </RadioGroupLabel>
        ...
        >
          ...
          <div class="mt-10">
            <h3 class="text-sm font-medium text-gray-900">{{useTrans('product.highlights')}}</h3>
